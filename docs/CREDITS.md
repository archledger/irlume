...
- **[FLIR liveness](https://modelscope.cn/models/damo/cv_manual_face-liveness_flir)** (Alibaba DAMO Academy on ModelScope, MIT; the `iic/` org path aliases the same page) is the shipped IR PAD cue (`flir.onnx`), default-on per ADR-0013.
