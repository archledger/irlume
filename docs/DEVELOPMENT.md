...
| `IRLUME_GKR_RUNTIME_DIR` | the runtime directory holding the GNOME keyring control socket and the user bus `irlume-gkr-unlock` watches (refused when privileged) | `/run/user/<uid>` |
