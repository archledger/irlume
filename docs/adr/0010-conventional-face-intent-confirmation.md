...
**Status:** Accepted; single-field prompt mechanics refined by [ADR-0011](0011-single-field-privileged-auth-input.md); owner opt-in waiver added by [ADR-0018](0018-owner-opt-in-privileged-consent-waiver.md)
**Date:** 2026-08-19
