...
- **Capture-path latency and pairing (ADR-0014, PR #518).** The rate-gate
  ...
  under the sequential budget defer the lit path's RGB-primary grant to the
  IR-identity-verified arms (fusion / IR fallback / centroid): the machinery
  gap is a physical swap window and the IR-side gates prove liveness, not
  identity. The delivered-rate tolerance widens 98%→97% (1.2% margin below
