...
impl Detector {
    pub fn load() -> lumen_common::Result<Self> {
        // TODO: load bundled YuNet ONNX via ort; GraphOpt Level3; cache session.
        todo!()
    }
    pub fn detect(&self, _frame: &lumen_camera::Frame) -> lumen_common::Result<Vec<Detection>> {
        todo!()
    }
}
...
impl Embedder {
    ...
    pub fn embed(&self, _chip112: &[u8]) -> lumen_common::Result<Embedding> {
        todo!()
    }
}
