...
| bona-fide baseline | 10 | — (BPCER 0/10) | [0%, 30.8%] | 0% | — |
...
it is not a robust fix: it false-rejects glasses / dry-eyes / off-angle users
...
Single-frame IR physics, on a 2D-IR (non-depth) camera, cannot robustly separate a
...
- **Challenge-response / temporal liveness** is the robust answer: a static print
